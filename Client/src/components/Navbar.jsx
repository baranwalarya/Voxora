    ...
    <div className='sticky top-0 z-50 backdrop-blur-xl bg-white/80 border-b border-orange-100'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between'>
            ...
            <div className='flex items-center gap-2.5' onClick={()=>navigate("/")}>
                ...
                <h1 className='font-bold text-xl text-gray-700 loading-none'>Voxora{" "}<span className='text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-emerald-500'>AI</span></h1>
            </div>
            ...
            {user && (<div className='hidden md:flex items-center gap-3'>
                ...
                <div className='flex items-center gap-3 px-4 py-2 rounded-2xl bg-white border border-orange-100 shadow-sm'>
                    ...
                    <div className='max-w-[140px]'>
                        ...
                        <button className='ml-1 text-gray-400 hover:text-red-500 transition-colors cursor-pointer' onClick={handleLogout}><FiLogOut size={18}/></button>
                </div>
            </div>)}
        ...
        {menuOpen && (
            <div className='md:hidden px-4 pb-4'>
                <div className='bg-white rounded-2xl border border-orange-100 shadow-lg p-4'>
                    ...
                    <button onClick={()=>{setMenuOpen(false);handleLogout()}} className='mt4 w-full flex items-center justify-center gap-2 py-2.5 rounded-xl bg-red-50 text-red-500 hover:bg-red-100 transition-colors text-sm font-medium'><FiLogOut size={16}/>LogOut</button>
