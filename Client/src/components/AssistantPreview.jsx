...
function AssistantPreview() {
  ...
  return (
    <div className='flex items-center justify-center px-3 sm:px-4 py-10 sm:py-14'>
        <div className={`relative w-[280px] h-[450px] sm:w-[330px] sm:h-[500px] md:w-[380px] md:h-[550px] rounded-[32px] sm:rounded-[42px] overflow-hidden transition-all duration-500 ${current.bg} ${current.cardBorder} shadow-[0_20px_80px_rgba(0,0,0.28)]`}>
