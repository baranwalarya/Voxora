          ...
          {editAssistant && <div className='space-y-6'>
            <div className='bg-white rounded-3xl border border-gray-100 shadow-sm p-6'>
              ...
              <div className='space-y-4'>
                ...
                <textarea type="text" rows={4} onChange={(e)=>setBusinessDescription(e.target.value)} value={businessDescription} placeholder='businessDescription' className='w-full border border-gray-200 rounded-2xl px-4 py-3 resize-none' />
            ...
            <div className='bg-white rounded-3xl border border-gray-100 shadow-sm p-6'>
              ...
              <div>
                ...
                <div className='grid grid-cols-2 sm:grid-cols-4 gap-3'>
                  {THEMES.map((item)=>(
                    <button key={item} onClick={()=>setTheme(item)} className={`py-3 rounded-2xl border-2 capitalize ${theme === item
              ...
              <div className='mt-6'>
                ...
                <div className='grid grid-cols-2 sm:grid-cols-3 gap-3'>
                  {TONES.map((item)=>(
                    <button key={item} onClick={()=>setTone(item)} className={`py-3 rounded-2xl border-2 capitalize ${tone === item
                      ? "border-purple-500 bg-purple-50 text-purple-700"
                      : "border-gray-200"
                    }`}>
                      {item}
            ...
            <div className='bg-white rounded-3xl border border-gray-100 shadow-sm p-6'>
              <div className='flex items-center justify-between mb-5 gap-4 flex-wrap'>
                ...
                <a href="https://aistudio.google.com/app/apikey" target='_blank' rel='noopener norefrence' className='px-4 py-2 rounded-xl bg-gradient-to-r from-purple-500 to-emerald-500 text-white text-sm font-medium hover:scale-[1.02] transition-all cursor-pointer'>Get API KEY</a>
              </div>
              ...
              <p className='text-xs text-gray-400 mt-3 leading-6'>
                Your API key is security stored and only used for generating AI responses.
              </p>
            </div>
